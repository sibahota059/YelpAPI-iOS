...
static NSString * const kConsumerKey       = @"<YOUR CONSUMER KEY>";
static NSString * const kConsumerSecret    = @"<YOUR CONSUMER SECRET>";
static NSString * const kToken             = @"<YOUR TOKEN>";
static NSString * const kTokenSecret       = @"<YOUR TOKEN SECRET>";
